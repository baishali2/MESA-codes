...
*main* branch : contains mesa-24.08.1/star/work : the original work directory of MESA version-24.08.1, which has been used in this project. Can be used for evolution of a star, masses, compositions and various other properties can be varied. *Note: to run this, you need to first have the mesa-24.08.1 or any other latest mesa version on your system/server. This is only the work directory, not the entire mesa module collection*
