...
! ***********************************************************************
      ...
      module run_star_extras
         ...
         real(dp), allocatable ,save:: t_force(:), f_force(:)
      ...
      subroutine holgado_simulation_force(id, ierr, M, a_in, a_out)
         ...
         call interpolate_force(s%time+t_shift , n_force, t_force, F_force, f_curr)  ! should be enough

         fd_arr =  -f_curr            !dyne (g cm s^-2) ! since the original phi data is negative, and we will be accounting for it in dEorb
         edot = -fd_arr*v                !erg/s  ! edot is negative, accounted for the sign in the energy injection, if not accounted for, it will give envelope collapse
